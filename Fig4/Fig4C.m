...
cof=parameter(1); %%%  the cooperativity constant 'h'
co=parameter(2);  %%% the ratio of the rewrapping rates to the unwrapping rates 'b_1/a_1'
BF=parameter(3);  %%%  the time fraction SDTF is unbound 'BF'.
r=parameter(4);   %%%  the SDTF effect range
